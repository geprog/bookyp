...
export const sampleSpaceWithUserRole = new Model.Space({
  _id: '623cfce8ce20e69a44b67eab',
  floorPlan: ['M1 1 L1 255', 'M0 255 L30 255', 'M30 255 L30 324', 'M30 324 L287 324', 'M287 324 L287 1', 'M287 1 L1 1'],
  members: [
    {
      role: 'user',
  ...
  name: 'New Space with user role',
});

export const sampleSpaces = [sampleSpace, sampleSpaceWithUserRole];
